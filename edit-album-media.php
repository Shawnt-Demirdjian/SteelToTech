					...
					<form class="col-12 d-flex" id="media" action="" method="post">
						<?php
							for($i=0; $i < $resMedia->num_rows; $i++){
								...
								echo '<input class="media-checkbox" name="'. $currentMedia .'" type="checkbox">';
								echo '</div>';
							}
						?>
						<div class="form-group col-12">
							<button type="submit" name="submit" class="btn btn-danger float-right">Delete Selected</button>
						</div>
					</form>
				</div>
				<div>
					...
					<form action="" method="post">
						<div class="form-group my-5 d-flex justify-content-center align-items-center">
							...
							<button type="submit" name="submit" class="btn btn-success ml-1">Add Pictures</button>
						</div>
					</form>
				</div>
			</div>
