			...
			<div class="container-fluid">
				...
				<div class="my-5 mx-auto row justify-content-center">
					<div class="text-center">
						...
						<button class="btn btn-danger col-12" data-toggle="modal" data-target="#delete-album-modal">Delete Album</button>
					</div>
				</div>
			</div>
		<?php else: ?>
			...
			<div class="modal-content">
				...
				<form class="mx-auto row justify-content-center" action="" method="post">
						<div class="form-group text-center">
							...
							<button class="form-control btn btn-danger col-6" type="submit" name="submit" value="delete">Delete Album</button>
						</div>
					</form>
				</div>
